...
<body id="page-top">
    ...
    if (!isset($_SESSION['usuario'])) { //! nega a frase
        //chama o login
        require "pages/login.php"; //qqr url, irá passar pelo index primeiro
        
        //com isso não tem a necessidade de fazer include em cada página de arquivo
    } else {
        if (isset($_GET['param'])) {
